...
static int runArithm(CPU* cpu, Instruction* ins,
                     void (*op)(CPU* cpu, Instruction*, uint64_t, uint64_t))
{
...
static int runArithmf(CPU* cpu, Instruction* ins,
                      void (*op)(CPU* cpu, Instruction*, double, double))
{
